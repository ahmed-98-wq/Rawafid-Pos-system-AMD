...
<form method="POST" action="?page=settings" enctype="multipart/form-data" id="settings-form">
  ...
  <path d="M9 21v-4a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v4" />
      ...
      <div class="form-group">
        ...
        <?php if (!empty($s['logo'])): ?>
        <div class="u-style-155"><img src="<?= BASE_URL ?>/uploads/<?= Helper::e($s['logo']) ?>" class="settings-logo-img" alt=""></div>
        <?php endif; ?>
  ...
  <path d="M19 16l3 3l-3 3" />
        ...
        <label class="btn btn-ghost u-style-157">
  ...
  <path d="M22 19h-6" />
          ...
          <input type="file" name="restore_file" accept=".sql" class="is-hidden"
