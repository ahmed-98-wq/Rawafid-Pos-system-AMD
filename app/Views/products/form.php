...
<form method="POST"
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <div class="qty-display-wrap">
              ...
              <small class="form-hint u-style-84">
                لتعديل الكمية → <a href="?page=inventory" class="u-style-85">صفحة المخزون</a>
              </small>
            </div>
            <?php else: ?>
            <input type="number"
  ...
  <path d="M12 3v3m0 12v3" />
        ...
        <!-- عرض هامش الربح -->
        <div id="profit-box" class="profit-preview is-hidden">
          <div class="pp-row">
          ...
          <div class="profit-bar-wrap">
            <div class="profit-bar u-style-86" id="pp-bar"></div>
          </div>
        </div>
      </div>
  ...
  <path d="M14 14l1 -1c.928 -.893 2.072 -.893 3 0l3 3" />
        ...
        <div id="img-preview-wrap" class="image-preview-wrap <?= !empty($p['image']) ? '' : 'is-hidden' ?>">
          <img id="img-preview"
               src="<?= !empty($p['image']) ? BASE_URL . '/uploads/' . Helper::e($p['image']) : '' ?>"
               alt="صورة المنتج"
               class="product-preview-img">
          <div class="u-style-87">الصورة الحالية</div>
        </div>
  ...
  <path d="M5 12l14 0" />
        ...
        <?php if ($isEdit): ?>
        <a href="?page=products&action=create" class="btn btn-outline btn-block mt-2">
           <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-plus" width="14" height="14" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M12 5l0 14" />
  <path d="M5 12l14 0" />
        ...
        <a href="?page=products" class="btn btn-ghost btn-block mt-2">
...
function calcProfit() {
  ...
  if (buy > 0 && sell > 0) {
    ...
    const clr    = margin >= 0 ? 'var(--olive-600)' : 'var(--danger)';
