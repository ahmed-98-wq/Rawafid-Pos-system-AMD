...
<div class="app-layout">
  ...
  <path d="M4 18l16 0" />
        ...
        <nav class="breadcrumb" aria-label="موقعك الحالي">
          <a href="?page=dashboard" class="u-style-60">الرئيسية</a>
          <?php if ($page !== 'dashboard'): ?>
          <span class="u-style-61">/</span>
          <span class="u-style-62"><?= htmlspecialchars($curPage, ENT_QUOTES, 'UTF-8') ?></span>
          <?php endif; ?>
        </nav>
      </div>
  ...
  <path d="M12 3c.132 0 .263 0 .393 .007a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454z" />
        ...
        <!-- Notifications -->
        <div class="topbar-btn clickable" onclick="toggleNotifications()" title="التنبيهات">
  ...
  <path d="M9 17v1a3 3 0 0 0 6 0v-1" />
    ...
    <div class="alert alert-success u-style-63">
  ...
  <path d="M9 12l2 2l4 -4" />
    ...
    <div class="alert alert-danger u-style-63">
  ...
  <path d="M12 16h.01" />
    ...
    <main class="page-content">
      ...
      } elseif ($page === 'products' && ($action === 'create' || $action === 'edit')) {
      ...
      if (file_exists($viewPath)) {
          ...
          echo '<div class="empty-state">
                  <i class="ti ti-tools u-style-64"></i>
                  <p class="text-muted">هذه الصفحة غير موجودة: ' . htmlspecialchars($viewPath) . '</p>
                </div>';
      }
      ?>
    </main>
  ...
  <div class="notif-list">
    ...
    try {
        ...
        <div class="notif-empty">
          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-circle-check u-style-65" width="14" height="14" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" />
  <path d="M9 12l2 2l4 -4" />
