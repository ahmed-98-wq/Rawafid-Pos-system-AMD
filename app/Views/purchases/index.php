...
<!-- Stats -->
<div class="mini-stats u-style-92">
  <div class="card u-style-93">
    <div class="u-style-94"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-receipt" width="14" height="14" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  ...
  <path d="M13 15l2 0" />
    ...
    <div><div class="u-style-95">فواتير هذا الشهر</div><div class="u-style-96"><?= count($purchases ?? []) ?></div></div>
  </div>
  <div class="card u-style-93">
    <div class="u-style-97"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-currency-dollar" width="14" height="14" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M16.7 8a3 3 0 0 0 -2.7 -2h-4a3 3 0 0 0 0 6h4a3 3 0 0 1 0 6h-4a3 3 0 0 1 -2.7 -2" />
  <path d="M12 3v3m0 12v3" />
</svg></div>
    <div><div class="u-style-95">إجمالي هذا الشهر</div><div class="u-style-96"><?= number_format($monthTotal,0) ?> <small class="cell-muted"><?= $currency ?></small></div></div>
  </div>
  <div class="card u-style-93">
    <div class="u-style-98"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-truck" width="14" height="14" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M7 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" />
  <path d="M17 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" />
  <path d="M5 17h-2v-11a1 1 0 0 1 1 -1h9v12m-4 0h6m4 0h1v-6h-4l-3 -5h-3v7" />
</svg></div>
    <div><div class="u-style-95">الموردون</div><div class="u-style-96"><?= count($suppliers) ?></div></div>
  </div>
</div>
...
<div class="card card-flush">
  <div class="table-wrap">
    <table class="data-table">
      <thead>
        <tr><th>رقم الفاتورة</th><th>المورد</th><th>الإجمالي</th><th>المدفوع</th><th>المتبقي</th><th>الحالة</th><th>التاريخ</th><th>المستخدم</th><th class="w-80">إجراءات</th></tr>
      </thead>
      <tbody>
  ...
  <path d="M3 3l18 18" />
          ...
          <!-- <i class="ti ti-shopping-cart-off u-style-2"></i> -->
            لا توجد فواتير مشتريات بعد
            <br><button class="btn btn-primary btn-sm mt-3" onclick="openModal('pur-modal')"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-plus" width="14" height="14" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M12 5l0 14" />
  <path d="M5 12l14 0" />
      ...
      ?>
        <tr>
          ...
          <td class="u-style-99"><?= Helper::e($p['supplier_name'] ?? '—') ?></td>
          <td class="fw-bold"><?= number_format($p['total'],2) ?> <small class="text-muted"><?= $currency ?></small></td>
          <td class="text-success fw-600"><?= number_format($p['paid_amount'],2) ?> <small class="text-muted"><?= $currency ?></small></td>
          <td><?= $remaining > 0 ? '<span class="u-style-35">'.number_format($remaining,2).' '.$currency.'</span>' : '<span class="u-style-36">مسدّد</span>' ?></td>
          <td><span class="badge <?= $sb[1] ?>"><?= $sb[0] ?></span></td>
          <td class="cell-muted"><?= Helper::formatDate($p['created_at'],'d/m/Y H:i') ?></td>
          <td class="cell-muted"><?= Helper::e($p['user_name'] ?? '') ?></td>
          <td>
...
<div class="modal-overlay is-hidden" id="pur-modal">
  <div class="modal-box u-style-100">
    <div class="modal-header">
      <div class="modal-title-group">
        <div class="u-style-50">🛒</div>
        <div><h3>فاتورة شراء جديدة</h3><p class="u-style-4">أضف الأصناف المشتراة</p></div>
      </div>
      <button onclick="closeModal('pur-modal')" class="icon-btn"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-x" width="14" height="14" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M18 6l-12 12" />
  <path d="M6 6l12 12" />
</svg></button>
    ...
    <form method="POST" action="?page=purchases&action=store" id="pur-form">
      ...
      <!-- جدول الأصناف -->
      <div class="u-style-101">
        <table class="u-style-102">
          <thead>
            <tr class="u-style-103">
              <th class="u-style-104">المنتج</th>
              <th class="u-style-105">الكمية</th>
              <th class="u-style-106">السعر</th>
              <th class="u-style-107">الإجمالي</th>
              <th class="u-style-108"></th>
            </tr>
          </thead>
      ...
      <button type="button" onclick="addPurItem()" class="btn btn-outline btn-sm mb-3">
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-plus" width="14" height="14" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M12 5l0 14" />
  <path d="M5 12l14 0" />
      ...
      <div class="form-row mb-3">
        <div class="form-group">
          ...
          <input type="number" name="total" id="pur-total" class="form-input u-style-109" step="0.01" readonly>
        </div>
        <div class="form-group">
      ...
      <div id="pur-remaining-box" class="u-style-110">
        <span class="u-style-111">المتبقي للمورد</span>
        <strong id="pur-remaining" class="u-style-111">—</strong>
      </div>
      ...
      <div class="modal-footer divider-top">
...
function addPurItem() {
  ...
  tr.innerHTML = `
    <td class="u-style-112">
      <select name="items[${i}][product_id]" class="form-select cell-regular" onchange="setPurPrice(${i},this)">
        <option value="">اختر منتجاً...</option>
        ${purProducts.map(p=>`<option value="${p.id}" data-price="${p.price}">${p.name} (${p.unit})</option>`).join('')}
      </select>
    </td>
    <td class="u-style-113">
      <input type="number" name="items[${i}][quantity]" class="form-input u-style-114" min="0.001" step="0.001" placeholder="0" oninput="calcPurTotal()">
    </td>
    <td class="u-style-113">
      <input type="number" name="items[${i}][price]" id="pur-price-${i}" class="form-input u-style-114" min="0" step="0.01" placeholder="0.00" oninput="calcPurTotal()">
    </td>
    <td class="u-style-115">
      <span id="pur-line-${i}" class="u-style-116">0.00</span>
    </td>
    <td class="u-style-115">
      <button type="button" onclick="removePurRow(${i})" class="u-style-117"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash" width="14" height="14" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M4 7l16 0" />
  <path d="M10 11l0 6" />
  <path d="M14 11l0 6" />
